...
<?php 
    ...
    $result = mysqli_query($con, "SELECT Year(tahun) as tahun,IPM FROM pembangunan_manusia ORDER BY YEAR(tahun) ASC");
...
<head lang="kr">
    ...
    <title>Indeks Pembangunan Manusia Indonesia</title>
